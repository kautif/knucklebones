...
export default function Column (props) {
    ...
    return (
        <div className={`knucklebones__diceboard__column column_${props.column} player${props.player}`} onClick={(e) => props.setDiceVal(e, props.column, props.player, props.colArr, props.setColumn, props.diceArr)}>
